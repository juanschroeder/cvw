...
//
// Filename   : liteEthTop.v
// Device     : 
// LiteX sha1 : 4568f9cea
// Date       : 2026-01-12 18:46:32
//------------------------------------------------------------------------------
...
module liteEthTop (
    ...
    input  wire    [1:0] rmii_rx_data,
    output reg     [1:0] rmii_tx_data,
...
reg           core_liteethmaccrc32checker_crc_error1_liteethmac_next_value1 = 1'd0;
reg           core_liteethmaccrc32checker_crc_error1_liteethmac_next_value_ce1 = 1'd0;
...
reg           core_liteethmaccrc32checker_last_be_liteethmac_next_value0 = 1'd0;
reg           core_liteethmaccrc32checker_last_be_liteethmac_next_value_ce0 = 1'd0;
...
reg    [31:0] core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value0 = 32'd0;
reg           core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value_ce0 = 1'd0;
...
reg           core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value1 = 1'd0;
reg           core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value_ce1 = 1'd0;
...
reg     [3:0] core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value = 4'd0;
reg           core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value_ce = 1'd0;
...
reg    [15:0] core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value = 16'd0;
reg           core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value_ce = 1'd0;
...
reg     [2:0] core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value = 3'd0;
reg           core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value_ce = 1'd0;
...
wire          maccore_ethphy_liteethphyrmiirx_ce;
reg     [1:0] maccore_ethphy_liteethphyrmiirx_converter_demux = 2'd0;
wire          maccore_ethphy_liteethphyrmiirx_converter_load_part;
reg           maccore_ethphy_liteethphyrmiirx_converter_sink_first = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_converter_sink_last = 1'd0;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_converter_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_converter_sink_ready;
reg           maccore_ethphy_liteethphyrmiirx_converter_sink_valid = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_converter_source_first = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_converter_source_last = 1'd0;
reg     [7:0] maccore_ethphy_liteethphyrmiirx_converter_source_payload_data = 8'd0;
reg     [2:0] maccore_ethphy_liteethphyrmiirx_converter_source_payload_valid_token_count = 3'd0;
wire          maccore_ethphy_liteethphyrmiirx_converter_source_ready;
wire          maccore_ethphy_liteethphyrmiirx_converter_source_valid;
reg           maccore_ethphy_liteethphyrmiirx_converter_strobe_all = 1'd0;
reg     [9:0] maccore_ethphy_liteethphyrmiirx_count = 10'd0;
reg     [9:0] maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value0 = 10'd0;
reg           maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value_ce0 = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_crs_dv = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_crs_dv_d = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_crs_dv_i = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_crs_first = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_crs_last = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_crs_run = 1'd0;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_first;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_last;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_ready;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_valid;
reg           maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_first = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_last = 1'd0;
reg     [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_payload_data = 2'd0;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_ready;
reg           maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_valid = 1'd0;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_first;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_last;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_ready;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_valid;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_first;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_last;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_ready;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_valid;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_first;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_last;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_ready;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_valid;
reg           maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_first = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_last = 1'd0;
reg     [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_payload_data = 2'd0;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_ready;
reg           maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_valid = 1'd0;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_first;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_last;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_ready;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_valid;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_first;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_last;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_ready;
wire          maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_valid;
reg           maccore_ethphy_liteethphyrmiirx_delay_sink_first = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_delay_sink_last = 1'd0;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiirx_delay_sink_ready;
wire          maccore_ethphy_liteethphyrmiirx_delay_sink_valid;
wire          maccore_ethphy_liteethphyrmiirx_delay_source_first;
wire          maccore_ethphy_liteethphyrmiirx_delay_source_last;
wire    [1:0] maccore_ethphy_liteethphyrmiirx_delay_source_payload_data;
reg           maccore_ethphy_liteethphyrmiirx_delay_source_ready = 1'd0;
wire          maccore_ethphy_liteethphyrmiirx_delay_source_valid;
reg           maccore_ethphy_liteethphyrmiirx_rst = 1'd0;
reg     [1:0] maccore_ethphy_liteethphyrmiirx_rx_data = 2'd0;
reg     [1:0] maccore_ethphy_liteethphyrmiirx_rx_data_i = 2'd0;
wire          maccore_ethphy_liteethphyrmiirx_source_source_first0;
wire          maccore_ethphy_liteethphyrmiirx_source_source_first1;
wire          maccore_ethphy_liteethphyrmiirx_source_source_last0;
wire          maccore_ethphy_liteethphyrmiirx_source_source_last1;
wire    [7:0] maccore_ethphy_liteethphyrmiirx_source_source_payload_data0;
wire    [7:0] maccore_ethphy_liteethphyrmiirx_source_source_payload_data1;
reg           maccore_ethphy_liteethphyrmiirx_source_source_payload_error = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_source_source_payload_last_be = 1'd0;
wire          maccore_ethphy_liteethphyrmiirx_source_source_ready0;
wire          maccore_ethphy_liteethphyrmiirx_source_source_ready1;
wire          maccore_ethphy_liteethphyrmiirx_source_source_valid0;
wire          maccore_ethphy_liteethphyrmiirx_source_source_valid1;
wire          maccore_ethphy_liteethphyrmiirx_speed0;
reg           maccore_ethphy_liteethphyrmiirx_speed1 = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value1 = 1'd0;
reg           maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value_ce1 = 1'd0;
reg     [3:0] maccore_ethphy_liteethphyrmiirx_timer = 4'd0;
wire          maccore_ethphy_liteethphyrmiitx_ce;
wire          maccore_ethphy_liteethphyrmiitx_converter_first;
wire          maccore_ethphy_liteethphyrmiitx_converter_last;
reg     [1:0] maccore_ethphy_liteethphyrmiitx_converter_mux = 2'd0;
reg           maccore_ethphy_liteethphyrmiitx_converter_sink_first = 1'd0;
reg           maccore_ethphy_liteethphyrmiitx_converter_sink_last = 1'd0;
wire    [7:0] maccore_ethphy_liteethphyrmiitx_converter_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiitx_converter_sink_ready;
wire          maccore_ethphy_liteethphyrmiitx_converter_sink_valid;
wire          maccore_ethphy_liteethphyrmiitx_converter_source_first;
wire          maccore_ethphy_liteethphyrmiitx_converter_source_last;
reg     [1:0] maccore_ethphy_liteethphyrmiitx_converter_source_payload_data = 2'd0;
wire          maccore_ethphy_liteethphyrmiitx_converter_source_payload_valid_token_count;
wire          maccore_ethphy_liteethphyrmiitx_converter_source_ready;
wire          maccore_ethphy_liteethphyrmiitx_converter_source_valid;
wire          maccore_ethphy_liteethphyrmiitx_rst;
wire          maccore_ethphy_liteethphyrmiitx_sink_first;
wire          maccore_ethphy_liteethphyrmiitx_sink_last;
wire    [7:0] maccore_ethphy_liteethphyrmiitx_sink_payload_data;
wire          maccore_ethphy_liteethphyrmiitx_sink_payload_error;
wire          maccore_ethphy_liteethphyrmiitx_sink_payload_last_be;
wire          maccore_ethphy_liteethphyrmiitx_sink_ready;
wire          maccore_ethphy_liteethphyrmiitx_sink_valid;
wire          maccore_ethphy_liteethphyrmiitx_source_source_first;
wire          maccore_ethphy_liteethphyrmiitx_source_source_last;
wire    [1:0] maccore_ethphy_liteethphyrmiitx_source_source_payload_data;
wire          maccore_ethphy_liteethphyrmiitx_source_source_ready;
wire          maccore_ethphy_liteethphyrmiitx_source_source_valid;
wire          maccore_ethphy_liteethphyrmiitx_speed;
reg     [3:0] maccore_ethphy_liteethphyrmiitx_timer = 4'd0;
...
reg    [10:0] wishbone_interface_reader_length_liteethmac_liteethmacsramreader_next_value = 11'd0;
...
reg    [31:0] wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value = 32'd0;
reg           wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value_ce = 1'd0;
...
reg    [10:0] wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value = 11'd0;
reg           wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value_ce = 1'd0;
...
reg           wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value = 1'd0;
reg           wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value_ce = 1'd0;
...
always @(*) begin
    master <= 3'd0;
    master[0] <= (shared_adr[29:10] == 17'd69632);
    master[1] <= (shared_adr[29:10] == 17'd69633);
...
assign maccore_ethphy_liteethphyrmiitx_speed = maccore_ethphy_liteethphyrmiirx_speed0;
assign maccore_ethphy_reset0 = (maccore_ethphy_reset_storage | maccore_ethphy_reset1);
assign rmii_rst_n = (~maccore_ethphy_reset0);
...
assign maccore_ethphy_liteethphyrmiitx_rst = (~maccore_ethphy_liteethphyrmiitx_sink_valid);
assign maccore_ethphy_liteethphyrmiitx_converter_sink_valid = maccore_ethphy_liteethphyrmiitx_sink_valid;
assign maccore_ethphy_liteethphyrmiitx_sink_ready = maccore_ethphy_liteethphyrmiitx_converter_sink_ready;
assign maccore_ethphy_liteethphyrmiitx_converter_sink_payload_data = maccore_ethphy_liteethphyrmiitx_sink_payload_data;
assign maccore_ethphy_liteethphyrmiitx_source_source_ready = maccore_ethphy_liteethphyrmiitx_ce;
assign maccore_ethphy_liteethphyrmiitx_ce = (maccore_ethphy_liteethphyrmiitx_timer == 1'd0);
assign maccore_ethphy_liteethphyrmiitx_source_source_valid = maccore_ethphy_liteethphyrmiitx_converter_source_valid;
assign maccore_ethphy_liteethphyrmiitx_converter_source_ready = maccore_ethphy_liteethphyrmiitx_source_source_ready;
assign maccore_ethphy_liteethphyrmiitx_source_source_first = maccore_ethphy_liteethphyrmiitx_converter_source_first;
assign maccore_ethphy_liteethphyrmiitx_source_source_last = maccore_ethphy_liteethphyrmiitx_converter_source_last;
assign maccore_ethphy_liteethphyrmiitx_source_source_payload_data = maccore_ethphy_liteethphyrmiitx_converter_source_payload_data;
assign maccore_ethphy_liteethphyrmiitx_converter_first = (maccore_ethphy_liteethphyrmiitx_converter_mux == 1'd0);
assign maccore_ethphy_liteethphyrmiitx_converter_last = (maccore_ethphy_liteethphyrmiitx_converter_mux == 2'd3);
assign maccore_ethphy_liteethphyrmiitx_converter_source_valid = maccore_ethphy_liteethphyrmiitx_converter_sink_valid;
assign maccore_ethphy_liteethphyrmiitx_converter_source_first = (maccore_ethphy_liteethphyrmiitx_converter_sink_first & maccore_ethphy_liteethphyrmiitx_converter_first);
assign maccore_ethphy_liteethphyrmiitx_converter_source_last = (maccore_ethphy_liteethphyrmiitx_converter_sink_last & maccore_ethphy_liteethphyrmiitx_converter_last);
assign maccore_ethphy_liteethphyrmiitx_converter_sink_ready = (maccore_ethphy_liteethphyrmiitx_converter_last & maccore_ethphy_liteethphyrmiitx_converter_source_ready);
always @(*) begin
    maccore_ethphy_liteethphyrmiitx_converter_source_payload_data <= 2'd0;
    case (maccore_ethphy_liteethphyrmiitx_converter_mux)
        1'd0: begin
            maccore_ethphy_liteethphyrmiitx_converter_source_payload_data <= maccore_ethphy_liteethphyrmiitx_converter_sink_payload_data[1:0];
        end
        1'd1: begin
            maccore_ethphy_liteethphyrmiitx_converter_source_payload_data <= maccore_ethphy_liteethphyrmiitx_converter_sink_payload_data[3:2];
        end
        2'd2: begin
            maccore_ethphy_liteethphyrmiitx_converter_source_payload_data <= maccore_ethphy_liteethphyrmiitx_converter_sink_payload_data[5:4];
        end
        default: begin
            maccore_ethphy_liteethphyrmiitx_converter_source_payload_data <= maccore_ethphy_liteethphyrmiitx_converter_sink_payload_data[7:6];
        end
    endcase
end
assign maccore_ethphy_liteethphyrmiitx_converter_source_payload_valid_token_count = maccore_ethphy_liteethphyrmiitx_converter_last;
always @(*) begin
    maccore_ethphy_liteethphyrmiirx_crs_first <= 1'd0;
    maccore_ethphy_liteethphyrmiirx_crs_last <= 1'd0;
    if (maccore_ethphy_liteethphyrmiirx_ce) begin
        maccore_ethphy_liteethphyrmiirx_crs_first <= (maccore_ethphy_liteethphyrmiirx_crs_dv & (maccore_ethphy_liteethphyrmiirx_rx_data != 1'd0));
        maccore_ethphy_liteethphyrmiirx_crs_last <= ((~maccore_ethphy_liteethphyrmiirx_crs_dv) & (~maccore_ethphy_liteethphyrmiirx_crs_dv_d));
    end
end
assign maccore_ethphy_liteethphyrmiirx_delay_sink_valid = (maccore_ethphy_liteethphyrmiirx_crs_first | (maccore_ethphy_liteethphyrmiirx_crs_run & maccore_ethphy_liteethphyrmiirx_ce));
assign maccore_ethphy_liteethphyrmiirx_delay_sink_payload_data = maccore_ethphy_liteethphyrmiirx_rx_data;
assign maccore_ethphy_liteethphyrmiirx_converter_sink_payload_data = maccore_ethphy_liteethphyrmiirx_delay_source_payload_data;
always @(*) begin
    maccore_ethphy_liteethphyrmiirx_converter_sink_last <= 1'd0;
    maccore_ethphy_liteethphyrmiirx_converter_sink_valid <= 1'd0;
    maccore_ethphy_liteethphyrmiirx_delay_source_ready <= 1'd0;
    maccore_ethphy_liteethphyrmiirx_delay_source_ready <= (~maccore_ethphy_liteethphyrmiirx_crs_run);
    if ((maccore_ethphy_liteethphyrmiirx_crs_run & maccore_ethphy_liteethphyrmiirx_ce)) begin
        maccore_ethphy_liteethphyrmiirx_converter_sink_valid <= maccore_ethphy_liteethphyrmiirx_delay_source_valid;
        maccore_ethphy_liteethphyrmiirx_delay_source_ready <= maccore_ethphy_liteethphyrmiirx_converter_sink_ready;
        maccore_ethphy_liteethphyrmiirx_converter_sink_last <= maccore_ethphy_liteethphyrmiirx_crs_last;
    end
end
assign maccore_ethphy_liteethphyrmiirx_source_source_valid0 = maccore_ethphy_liteethphyrmiirx_source_source_valid1;
assign maccore_ethphy_liteethphyrmiirx_source_source_ready1 = maccore_ethphy_liteethphyrmiirx_source_source_ready0;
assign maccore_ethphy_liteethphyrmiirx_source_source_first0 = maccore_ethphy_liteethphyrmiirx_source_source_first1;
assign maccore_ethphy_liteethphyrmiirx_source_source_last0 = maccore_ethphy_liteethphyrmiirx_source_source_last1;
assign maccore_ethphy_liteethphyrmiirx_source_source_payload_data0 = maccore_ethphy_liteethphyrmiirx_source_source_payload_data1;
assign maccore_ethphy_liteethphyrmiirx_speed0 = maccore_ethphy_liteethphyrmiirx_speed1;
assign maccore_ethphy_liteethphyrmiirx_ce = (maccore_ethphy_liteethphyrmiirx_timer == 1'd0);
assign maccore_ethphy_liteethphyrmiirx_source_source_valid1 = maccore_ethphy_liteethphyrmiirx_converter_source_valid;
assign maccore_ethphy_liteethphyrmiirx_converter_source_ready = maccore_ethphy_liteethphyrmiirx_source_source_ready1;
assign maccore_ethphy_liteethphyrmiirx_source_source_first1 = maccore_ethphy_liteethphyrmiirx_converter_source_first;
assign maccore_ethphy_liteethphyrmiirx_source_source_last1 = maccore_ethphy_liteethphyrmiirx_converter_source_last;
assign maccore_ethphy_liteethphyrmiirx_source_source_payload_data1 = maccore_ethphy_liteethphyrmiirx_converter_source_payload_data;
assign maccore_ethphy_liteethphyrmiirx_converter_sink_ready = ((~maccore_ethphy_liteethphyrmiirx_converter_strobe_all) | maccore_ethphy_liteethphyrmiirx_converter_source_ready);
assign maccore_ethphy_liteethphyrmiirx_converter_source_valid = maccore_ethphy_liteethphyrmiirx_converter_strobe_all;
assign maccore_ethphy_liteethphyrmiirx_converter_load_part = (maccore_ethphy_liteethphyrmiirx_converter_sink_valid & maccore_ethphy_liteethphyrmiirx_converter_sink_ready);
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_ready = ((~maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_valid) | maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_ready);
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_valid = maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_valid;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_ready = maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_ready;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_first = maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_first;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_last = maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_last;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_payload_data = maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_payload_data;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_valid = maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_valid;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_ready = maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_ready;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_first = maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_first;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_last = maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_last;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_payload_data = maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_payload_data;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_ready = ((~maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_valid) | maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_ready);
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_valid = maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_valid;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_ready = maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_ready;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_first = maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_first;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_last = maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_last;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_payload_data = maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_payload_data;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_valid = maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_valid;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_ready = maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_ready;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_first = maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_first;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_last = maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_last;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_payload_data = maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_payload_data;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_valid = maccore_ethphy_liteethphyrmiirx_delay_sink_valid;
assign maccore_ethphy_liteethphyrmiirx_delay_sink_ready = maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_ready;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_first = maccore_ethphy_liteethphyrmiirx_delay_sink_first;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_last = maccore_ethphy_liteethphyrmiirx_delay_sink_last;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_sink_sink_payload_data = maccore_ethphy_liteethphyrmiirx_delay_sink_payload_data;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_valid = maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_valid;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_ready = maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_ready;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_first = maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_first;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_last = maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_last;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_sink_sink_payload_data = maccore_ethphy_liteethphyrmiirx_delay_buffer0_source_source_payload_data;
assign maccore_ethphy_liteethphyrmiirx_delay_source_valid = maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_valid;
assign maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_ready = maccore_ethphy_liteethphyrmiirx_delay_source_ready;
assign maccore_ethphy_liteethphyrmiirx_delay_source_first = maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_first;
assign maccore_ethphy_liteethphyrmiirx_delay_source_last = maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_last;
assign maccore_ethphy_liteethphyrmiirx_delay_source_payload_data = maccore_ethphy_liteethphyrmiirx_delay_buffer1_source_source_payload_data;
always @(*) begin
    liteethphyrmii_next_state <= 2'd0;
    maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value0 <= 10'd0;
    maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value_ce0 <= 1'd0;
    maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value1 <= 1'd0;
    maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value_ce1 <= 1'd0;
    liteethphyrmii_next_state <= liteethphyrmii_state;
    case (liteethphyrmii_state)
        1'd1: begin
            maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value0 <= (maccore_ethphy_liteethphyrmiirx_count + 1'd1);
            maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value_ce0 <= 1'd1;
            if (maccore_ethphy_liteethphyrmiirx_rx_data_i[0]) begin
                if ((maccore_ethphy_liteethphyrmiirx_count < 5'd20)) begin
                    maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value1 <= 1'd1;
                    maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value_ce1 <= 1'd1;
                end else begin
                    maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value1 <= 1'd0;
                    maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value_ce1 <= 1'd1;
                end
            ...
            if ((~maccore_ethphy_liteethphyrmiirx_crs_dv_i)) begin
                liteethphyrmii_next_state <= 2'd2;
            end
        end
        2'd2: begin
            if (maccore_ethphy_liteethphyrmiirx_crs_last) begin
                liteethphyrmii_next_state <= 1'd0;
            end
        end
        default: begin
            if (maccore_ethphy_liteethphyrmiirx_crs_dv_i) begin
                maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value0 <= 1'd0;
                maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value_ce0 <= 1'd1;
...
assign rmii_mdc = maccore_ethphy__w_storage[0];
...
always @(*) begin
    core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value <= 16'd0;
    core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value_ce <= 1'd0;
    ...
    case (txdatapath_liteethmacpaddinginserter_state)
        1'd1: begin
            ...
            if ((core_tx_padding_source_valid & core_tx_padding_source_ready)) begin
                core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value <= (core_tx_padding_counter + 1'd1);
                core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value_ce <= 1'd1;
                if (core_tx_padding_counter_done) begin
                    core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value <= 1'd0;
                    core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value_ce <= 1'd1;
                    txdatapath_liteethmacpaddinginserter_next_state <= 1'd0;
                end
            end
...
always @(*) begin
    core_tx_crc_ce <= 1'd0;
    core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value0 <= 32'd0;
    core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value_ce0 <= 1'd0;
    core_tx_crc_fsm_is_ongoing0 <= 1'd0;
    core_tx_crc_fsm_is_ongoing1 <= 1'd0;
    core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value1 <= 1'd0;
    core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value_ce1 <= 1'd0;
        ...
        1'd1: begin
            ...
            if (((core_tx_crc_sink_valid & core_tx_crc_sink_last) & core_tx_crc_source_ready)) begin
                if ((1'd0 & (core_tx_crc_sink_payload_last_be <= 4'd15))) begin
                    ...
                    core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value0 <= core_tx_crc_value;
                    core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value_ce0 <= 1'd1;
                    if (1'd0) begin
                        core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value1 <= (core_tx_crc_sink_payload_last_be >>> 3'd4);
                        core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value_ce1 <= 1'd1;
                    end else begin
                        core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value1 <= core_tx_crc_sink_payload_last_be;
                        core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value_ce1 <= 1'd1;
                    end
...
always @(*) begin
    core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value <= 3'd0;
    core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value_ce <= 1'd0;
    ...
    case (txdatapath_liteethmacpreambleinserter_state)
        1'd1: begin
            ...
            if (core_tx_preamble_source_ready) begin
                if ((core_tx_preamble_count == 3'd7)) begin
                    ...
                    core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value <= (core_tx_preamble_count + 1'd1);
                    core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value_ce <= 1'd1;
                end
            end
        end
        2'd2: begin
        ...
        default: begin
            ...
            core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value <= 1'd0;
            core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value_ce <= 1'd1;
...
always @(*) begin
    core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value <= 4'd0;
    core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value_ce <= 1'd0;
    ...
    case (txdatapath_liteethmacgap_state)
        1'd1: begin
            core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value <= (core_tx_gap_counter + 1'd1);
            core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value_ce <= 1'd1;
            if ((core_tx_gap_counter == 4'd11)) begin
                txdatapath_liteethmacgap_next_state <= 1'd0;
            end
        end
        default: begin
            core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value <= 1'd0;
            core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value_ce <= 1'd1;
...
assign maccore_ethphy_liteethphyrmiitx_sink_valid = core_tx_gap_source_valid;
assign core_tx_gap_source_ready = maccore_ethphy_liteethphyrmiitx_sink_ready;
assign maccore_ethphy_liteethphyrmiitx_sink_first = core_tx_gap_source_first;
assign maccore_ethphy_liteethphyrmiitx_sink_last = core_tx_gap_source_last;
assign maccore_ethphy_liteethphyrmiitx_sink_payload_data = core_tx_gap_source_payload_data;
assign maccore_ethphy_liteethphyrmiitx_sink_payload_last_be = core_tx_gap_source_payload_last_be;
assign maccore_ethphy_liteethphyrmiitx_sink_payload_error = core_tx_gap_source_payload_error;
...
always @(*) begin
    ...
    core_liteethmaccrc32checker_crc_error1_liteethmac_next_value1 <= 1'd0;
    core_liteethmaccrc32checker_crc_error1_liteethmac_next_value_ce1 <= 1'd0;
    ...
    core_liteethmaccrc32checker_last_be_liteethmac_next_value0 <= 1'd0;
    core_liteethmaccrc32checker_last_be_liteethmac_next_value_ce0 <= 1'd0;
        ...
        2'd2: begin
            ...
            if (1'd1) begin
                ...
                if ((core_liteethmaccrc32checker_sink_sink_payload_last_be & 4'd15)) begin
                    ...
                    core_liteethmaccrc32checker_last_be_liteethmac_next_value0 <= (core_liteethmaccrc32checker_sink_sink_payload_last_be >>> 3'd4);
                    core_liteethmaccrc32checker_last_be_liteethmac_next_value_ce0 <= 1'd1;
                    core_liteethmaccrc32checker_crc_error1_liteethmac_next_value1 <= core_liteethmaccrc32checker_crc_error0;
                    core_liteethmaccrc32checker_crc_error1_liteethmac_next_value_ce1 <= 1'd1;
                end
            end
...
assign core_rx_preamble_sink_valid = maccore_ethphy_liteethphyrmiirx_source_source_valid0;
assign maccore_ethphy_liteethphyrmiirx_source_source_ready0 = core_rx_preamble_sink_ready;
assign core_rx_preamble_sink_first = maccore_ethphy_liteethphyrmiirx_source_source_first0;
assign core_rx_preamble_sink_last = maccore_ethphy_liteethphyrmiirx_source_source_last0;
assign core_rx_preamble_sink_payload_data = maccore_ethphy_liteethphyrmiirx_source_source_payload_data0;
assign core_rx_preamble_sink_payload_last_be = maccore_ethphy_liteethphyrmiirx_source_source_payload_last_be;
assign core_rx_preamble_sink_payload_error = maccore_ethphy_liteethphyrmiirx_source_source_payload_error;
...
always @(*) begin
    ...
    wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value <= 32'd0;
    wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value_ce <= 1'd0;
    wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value <= 11'd0;
    wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value_ce <= 1'd0;
    wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value <= 1'd0;
    wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value_ce <= 1'd0;
    ...
    case (liteethmacsramwriter_state)
        ...
        2'd2: begin
            if ((wishbone_interface_writer_sink_sink_valid & wishbone_interface_writer_sink_sink_last)) begin
                if ((wishbone_interface_writer_sink_sink_payload_last_be != 1'd0)) begin
                    ...
                    wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value <= 1'd0;
                    wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value_ce <= 1'd1;
        ...
        3'd4: begin
            ...
            wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value <= 1'd0;
            wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value_ce <= 1'd1;
            wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value <= (wishbone_interface_writer_slot + 1'd1);
            wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value_ce <= 1'd1;
            liteethmacsramwriter_next_state <= 1'd0;
        end
        default: begin
            if (wishbone_interface_writer_sink_sink_valid) begin
                if (wishbone_interface_writer_stat_fifo_sink_ready) begin
                    ...
                    wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value <= (wishbone_interface_writer_length + wishbone_interface_writer_length_inc);
                    wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value_ce <= 1'd1;
                    ...
                    wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value <= (wishbone_interface_writer_errors_status + 1'd1);
                    wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value_ce <= 1'd1;
...
assign sdrio_clk = rmii_clocks_ref_clk;
assign sdrio_clk_1 = rmii_clocks_ref_clk;
assign sdrio_clk_2 = rmii_clocks_ref_clk;
assign sdrio_clk_3 = rmii_clocks_ref_clk;
always @(*) begin
...
always @(posedge rmii_clocks_ref_clk) begin
    if (maccore_ethphy_liteethphyrmiirx_ce) begin
        maccore_ethphy_liteethphyrmiirx_crs_dv <= maccore_ethphy_liteethphyrmiirx_crs_dv_i;
        maccore_ethphy_liteethphyrmiirx_rx_data <= maccore_ethphy_liteethphyrmiirx_rx_data_i;
    end
    if (maccore_ethphy_liteethphyrmiirx_ce) begin
        maccore_ethphy_liteethphyrmiirx_crs_dv_d <= maccore_ethphy_liteethphyrmiirx_crs_dv;
    end
    if (maccore_ethphy_liteethphyrmiirx_crs_first) begin
        maccore_ethphy_liteethphyrmiirx_crs_run <= 1'd1;
    end
    if (maccore_ethphy_liteethphyrmiirx_crs_last) begin
        maccore_ethphy_liteethphyrmiirx_crs_run <= 1'd0;
    end
    maccore_ethphy_liteethphyrmiirx_timer <= (maccore_ethphy_liteethphyrmiirx_timer - 1'd1);
    if ((maccore_ethphy_liteethphyrmiirx_ce | maccore_ethphy_liteethphyrmiirx_rst)) begin
        case (maccore_ethphy_liteethphyrmiirx_speed0)
            1'd0: begin
                maccore_ethphy_liteethphyrmiirx_timer <= 4'd9;
            end
            1'd1: begin
                maccore_ethphy_liteethphyrmiirx_timer <= 1'd0;
            end
        endcase
    end
    if (maccore_ethphy_liteethphyrmiirx_converter_source_ready) begin
        maccore_ethphy_liteethphyrmiirx_converter_strobe_all <= 1'd0;
    end
    if (maccore_ethphy_liteethphyrmiirx_converter_load_part) begin
        if (((maccore_ethphy_liteethphyrmiirx_converter_demux == 2'd3) | maccore_ethphy_liteethphyrmiirx_converter_sink_last)) begin
            maccore_ethphy_liteethphyrmiirx_converter_demux <= 1'd0;
            maccore_ethphy_liteethphyrmiirx_converter_strobe_all <= 1'd1;
        end else begin
            maccore_ethphy_liteethphyrmiirx_converter_demux <= (maccore_ethphy_liteethphyrmiirx_converter_demux + 1'd1);
        end
    end
    if ((maccore_ethphy_liteethphyrmiirx_converter_source_valid & maccore_ethphy_liteethphyrmiirx_converter_source_ready)) begin
        if ((maccore_ethphy_liteethphyrmiirx_converter_sink_valid & maccore_ethphy_liteethphyrmiirx_converter_sink_ready)) begin
            maccore_ethphy_liteethphyrmiirx_converter_source_first <= maccore_ethphy_liteethphyrmiirx_converter_sink_first;
            maccore_ethphy_liteethphyrmiirx_converter_source_last <= maccore_ethphy_liteethphyrmiirx_converter_sink_last;
        end else begin
            maccore_ethphy_liteethphyrmiirx_converter_source_first <= 1'd0;
            maccore_ethphy_liteethphyrmiirx_converter_source_last <= 1'd0;
        end
    end else begin
        if ((maccore_ethphy_liteethphyrmiirx_converter_sink_valid & maccore_ethphy_liteethphyrmiirx_converter_sink_ready)) begin
            maccore_ethphy_liteethphyrmiirx_converter_source_first <= (maccore_ethphy_liteethphyrmiirx_converter_sink_first | maccore_ethphy_liteethphyrmiirx_converter_source_first);
            maccore_ethphy_liteethphyrmiirx_converter_source_last <= (maccore_ethphy_liteethphyrmiirx_converter_sink_last | maccore_ethphy_liteethphyrmiirx_converter_source_last);
        end
    end
    if (maccore_ethphy_liteethphyrmiirx_converter_load_part) begin
        case (maccore_ethphy_liteethphyrmiirx_converter_demux)
            1'd0: begin
                maccore_ethphy_liteethphyrmiirx_converter_source_payload_data[1:0] <= maccore_ethphy_liteethphyrmiirx_converter_sink_payload_data;
            end
            1'd1: begin
                maccore_ethphy_liteethphyrmiirx_converter_source_payload_data[3:2] <= maccore_ethphy_liteethphyrmiirx_converter_sink_payload_data;
            end
            2'd2: begin
                maccore_ethphy_liteethphyrmiirx_converter_source_payload_data[5:4] <= maccore_ethphy_liteethphyrmiirx_converter_sink_payload_data;
            end
            2'd3: begin
                maccore_ethphy_liteethphyrmiirx_converter_source_payload_data[7:6] <= maccore_ethphy_liteethphyrmiirx_converter_sink_payload_data;
            end
        endcase
    end
    if (maccore_ethphy_liteethphyrmiirx_converter_load_part) begin
        maccore_ethphy_liteethphyrmiirx_converter_source_payload_valid_token_count <= (maccore_ethphy_liteethphyrmiirx_converter_demux + 1'd1);
    end
    if (((~maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_valid) | maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_ready)) begin
        maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_valid <= maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_valid;
        maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_first <= maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_first;
        maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_last <= maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_last;
        maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_payload_data <= maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_sink_payload_data;
    end
    if (((~maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_valid) | maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_ready)) begin
        maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_valid <= maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_valid;
        maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_first <= maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_first;
        maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_last <= maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_last;
        maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_payload_data <= maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_sink_payload_data;
    end
    liteethphyrmii_state <= liteethphyrmii_next_state;
    if (maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value_ce0) begin
        maccore_ethphy_liteethphyrmiirx_count <= maccore_ethphy_liteethphyrmiirx_count_liteethphyrmii_next_value0;
    end
    if (maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value_ce1) begin
        maccore_ethphy_liteethphyrmiirx_speed1 <= maccore_ethphy_liteethphyrmiirx_speed1_liteethphyrmii_next_value1;
    end
    ...
    if (core_liteethmaccrc32checker_last_be_liteethmac_next_value_ce0) begin
        core_liteethmaccrc32checker_last_be <= core_liteethmaccrc32checker_last_be_liteethmac_next_value0;
    end
    if (core_liteethmaccrc32checker_crc_error1_liteethmac_next_value_ce1) begin
        core_liteethmaccrc32checker_crc_error1 <= core_liteethmaccrc32checker_crc_error1_liteethmac_next_value1;
    end
    ...
    if (eth_rx_rst) begin
        maccore_ethphy_liteethphyrmiirx_timer <= 4'd0;
        maccore_ethphy_liteethphyrmiirx_crs_dv <= 1'd0;
        maccore_ethphy_liteethphyrmiirx_rx_data <= 2'd0;
        maccore_ethphy_liteethphyrmiirx_converter_source_payload_data <= 8'd0;
        maccore_ethphy_liteethphyrmiirx_converter_source_payload_valid_token_count <= 3'd0;
        maccore_ethphy_liteethphyrmiirx_converter_demux <= 2'd0;
        maccore_ethphy_liteethphyrmiirx_converter_strobe_all <= 1'd0;
        maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_valid <= 1'd0;
        maccore_ethphy_liteethphyrmiirx_delay_buffer0_pipe_valid_source_payload_data <= 2'd0;
        maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_valid <= 1'd0;
        maccore_ethphy_liteethphyrmiirx_delay_buffer1_pipe_valid_source_payload_data <= 2'd0;
        maccore_ethphy_liteethphyrmiirx_crs_run <= 1'd0;
        maccore_ethphy_liteethphyrmiirx_crs_dv_d <= 1'd0;
        maccore_ethphy_liteethphyrmiirx_speed1 <= 1'd0;
        maccore_ethphy_liteethphyrmiirx_count <= 10'd0;
        core_liteethmaccrc32checker_crc_reg <= 32'd4294967295;
        core_liteethmaccrc32checker_syncfifo_level <= 3'd0;
        core_liteethmaccrc32checker_syncfifo_produce <= 3'd0;
        core_liteethmaccrc32checker_syncfifo_consume <= 3'd0;
...
always @(posedge rmii_clocks_ref_clk) begin
    maccore_ethphy_liteethphyrmiitx_timer <= (maccore_ethphy_liteethphyrmiitx_timer - 1'd1);
    if ((maccore_ethphy_liteethphyrmiitx_ce | maccore_ethphy_liteethphyrmiitx_rst)) begin
        case (maccore_ethphy_liteethphyrmiitx_speed)
            1'd0: begin
                maccore_ethphy_liteethphyrmiitx_timer <= 4'd9;
            end
            1'd1: begin
                maccore_ethphy_liteethphyrmiitx_timer <= 1'd0;
            end
        endcase
    end
    if ((maccore_ethphy_liteethphyrmiitx_converter_source_valid & maccore_ethphy_liteethphyrmiitx_converter_source_ready)) begin
        if (maccore_ethphy_liteethphyrmiitx_converter_last) begin
            maccore_ethphy_liteethphyrmiitx_converter_mux <= 1'd0;
        end else begin
            maccore_ethphy_liteethphyrmiitx_converter_mux <= (maccore_ethphy_liteethphyrmiitx_converter_mux + 1'd1);
        end
    end
    ...
    if (core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value_ce) begin
        core_tx_padding_counter <= core_tx_padding_counter_liteethmac_clockdomainsrenamer0_next_value;
    end
    ...
    if (core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value_ce0) begin
        core_tx_crc_description <= core_tx_crc_description_liteethmac_clockdomainsrenamer1_next_value0;
    end
    if (core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value_ce1) begin
        core_tx_crc_fsm <= core_tx_crc_fsm_liteethmac_clockdomainsrenamer1_next_value1;
    end
    ...
    if (core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value_ce) begin
        core_tx_preamble_count <= core_tx_preamble_count_liteethmac_clockdomainsrenamer2_next_value;
    end
    txdatapath_liteethmacgap_state <= txdatapath_liteethmacgap_next_state;
    if (core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value_ce) begin
        core_tx_gap_counter <= core_tx_gap_counter_liteethmac_clockdomainsrenamer3_next_value;
    end
    if (eth_tx_rst) begin
        maccore_ethphy_liteethphyrmiitx_timer <= 4'd0;
        maccore_ethphy_liteethphyrmiitx_converter_mux <= 2'd0;
...
always @(posedge sdrio_clk) begin
    rmii_tx_en <= maccore_ethphy_liteethphyrmiitx_source_source_valid;
    rmii_tx_data <= maccore_ethphy_liteethphyrmiitx_source_source_payload_data;
    maccore_ethphy_liteethphyrmiirx_crs_dv_i <= rmii_crs_dv;
    maccore_ethphy_liteethphyrmiirx_rx_data_i <= rmii_rx_data;
end
...
always @(posedge sys_clk) begin
    ...
    if (wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value_ce) begin
        wishbone_interface_writer_length <= wishbone_interface_writer_length_liteethmac_liteethmacsramwriter_t_next_value;
    end
    if (wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value_ce) begin
        wishbone_interface_writer_errors_status <= wishbone_interface_writer_errors_status_liteethmac_liteethmacsramwriter_f_next_value;
    end
    if (wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value_ce) begin
        wishbone_interface_writer_slot <= wishbone_interface_writer_slot_liteethmac_liteethmacsramwriter_next_value;
    end
    ...
    if (wishbone_interface_reader_length_liteethmac_liteethmacsramreader_next_value_ce) begin
        wishbone_interface_reader_length <= wishbone_interface_reader_length_liteethmac_liteethmacsramreader_next_value;
    end
...
assign rmii_mdio = maccore_ethphy_data_oe ? maccore_ethphy_data_w : 1'bz;
assign maccore_ethphy_data_r = rmii_mdio;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-01-12 18:46:32.
//------------------------------------------------------------------------------
