...
module uncore import cvw::*;  #(parameter cvw_t P)(
  ...
  assign {HSELAXILITEDRAM, HSELAXIETH, HSELAXIUSB, HSELAXIVGA, HSELAXIDMA, HSELWbIsland, HSELSPI, HSELSDC, HSELPLIC, HSELUART, HSELGPIO, HSELCLINT, HSELRam, HSELBootRom, HSELEXT_DDR, HSELIROM, HSELDTIM} = HSELRegions[17:1];
 ...
 if (P.BOOTROM_SUPPORTED) begin : bootrom
  ...
  // AXI Select signals
  assign HSELEXTD_ALL = HSELEXTD_DDR | HSELAXIDMAD | HSELAXIVGAD | HSELAXIUSBD | HSELAXIETHD | HSELAXILITEDRAMD;
  assign HSELEXT = HSELEXT_DDR | HSELAXIDMA | HSELAXIVGA | HSELAXIUSB | HSELAXIETH | HSELAXILITEDRAM; // OUTPUT
  ...
  flopenl #(18) hseldelayreg(HCLK, ~HRESETn, HREADY, HSELRegions, 18'b1,
    {HSELAXILITEDRAMD, HSELAXIETHD, HSELAXIUSBD, HSELAXIVGAD, HSELAXIDMAD, HSELWbIslandD, HSELSPID, HSELSDCD, HSELPLICD, HSELUARTD, HSELGPIOD, HSELCLINTD,
