...
#ifdef CVWSOC_FULL_TB
#define DUT_UART_RX testbench_cvwsoc_full__DOT__UARTSin
#define DUT_UART_TX testbench_cvwsoc_full__DOT__UARTSout
#define DUT_UART_CHAR_VALID testbench_cvwsoc_full__DOT__uart_char_valid
#define DUT_UART_CHAR_DATA testbench_cvwsoc_full__DOT__uart_char_data
#define DUT_UART_FCR testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__FCR
#define DUT_UART_RX_FIFO_HEAD testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__rxfifohead
#define DUT_UART_RX_FIFO_ENTRIES testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__rxfifoentries
#define DUT_UART_RX_DATA_READY testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__rxdataready
#define DUT_UART_RX_BUFFER testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__RXBR
#define DUT_UART_LSR testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__LSR
#define DUT_UART_RX_STATE testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__rxstate
#define DUT_UART_RX_SHIFTREG testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__rxshiftreg
#define DUT_UART_SIN_SYNC testbench_cvwsoc_full__DOT__ahb_island__DOT__system__DOT__apb__DOT__uartgen__DOT__uart__DOT__uartPC__DOT__SINsync
#endif
