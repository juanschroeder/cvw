...
exec cp ../xlnx_ddr2-nexysa7-mig.prj $ipName.srcs/sources_1/ip/$ipName/xlnx_ddr2-nexysa7-mig-modif.prj
...
set_property -dict [list CONFIG.XML_INPUT_FILE {xlnx_ddr2-nexysa7-mig-modif.prj} CONFIG.RESET_BOARD_INTERFACE {Custom} CONFIG.MIG_DONT_TOUCH_PARAM {Custom} CONFIG.BOARD_MIG_PARAM {Custom}] [get_ips $ipName]
