...
//
// Filename   : litedram_nexysa7_w64.v
// Top        : LiteDRAMCore
// Device     : 
// Hierarchy  : disabled
// LiteX sha1 : 777d97377
// Date       : 2026-07-22 00:49:50
//------------------------------------------------------------------------------
...
├── litedramaxi2native_0 (LiteDRAMAXI2Native) [Gen]
...
reg    [12:0] builder_rhs_self1 = 13'd0;
...
reg    [12:0] builder_rhs_self7 = 13'd0;
...
wire   [26:0] main_ar_payload_addr;
...
wire   [26:0] main_aw_payload_addr;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine0_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine0_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine0_trccon_ready = 1'd1;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine1_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine1_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine1_trccon_ready = 1'd1;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine2_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine2_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine2_trccon_ready = 1'd1;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine3_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine3_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine3_trccon_ready = 1'd1;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine4_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine4_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine4_trccon_ready = 1'd1;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine5_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine5_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine5_trccon_ready = 1'd1;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine6_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine6_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine6_trccon_ready = 1'd1;
...
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine7_trascon_ready = 1'd1;
wire          main_litedramcore_bankmachine7_trascon_valid;
(* dont_touch = "true" *)
reg           main_litedramcore_bankmachine7_trccon_ready = 1'd1;
...
reg     [7:0] main_litedramcore_choose_cmd_requests = 8'd0;
...
reg     [7:0] main_litedramcore_choose_req_requests = 8'd0;
...
wire   [12:0] main_litedramcore_csr_dfi_p0_address;
...
wire   [12:0] main_litedramcore_csr_dfi_p1_address;
...
reg    [12:0] main_litedramcore_ext_dfi_p0_address = 13'd0;
...
reg    [12:0] main_litedramcore_ext_dfi_p1_address = 13'd0;
...
wire          main_litedramcore_interface;
...
reg     [3:0] main_litedramcore_sequencer_trigger = 4'd0;
wire          main_litedramcore_settings;
...
wire    [8:0] main_litedramcore_timer_count0;
reg     [8:0] main_litedramcore_timer_count1 = 9'd468;
wire          main_litedramcore_timer_done0;
wire          main_litedramcore_timer_done1;
wire          main_litedramcore_timer_wait;
(* dont_touch = "true" *)
reg           main_litedramcore_trrdcon_ready = 1'd1;
...
wire   [26:0] main_read_ar_payload_addr;
...
wire   [26:0] main_read_pipe_valid_sink_payload_addr;
...
reg    [26:0] main_read_pipe_valid_source_payload_addr = 27'd0;
...
wire   [26:0] main_read_sink_sink_payload_addr;
...
wire   [26:0] main_read_source_source_payload_addr;
...
reg           main_user_port_cmd_last = 1'd0;
reg    [23:0] main_user_port_cmd_payload_addr = 24'd0;
reg           main_user_port_cmd_payload_we = 1'd0;
wire          main_user_port_cmd_ready;
reg           main_user_port_cmd_valid = 1'd0;
reg           main_user_port_rdata_first = 1'd0;
reg           main_user_port_rdata_last = 1'd0;
...
wire   [26:0] main_write_aw_payload_addr;
...
wire   [26:0] main_write_pipe_valid_sink_payload_addr;
...
reg    [26:0] main_write_pipe_valid_source_payload_addr = 27'd0;
...
wire   [26:0] main_write_sink_sink_payload_addr;
...
wire   [26:0] main_write_source_source_payload_addr;
...
assign main_litedramcore_bankmachine0_row_hit = (main_litedramcore_bankmachine0_row == main_litedramcore_bankmachine0_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine0_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine0_cmd_payload_a <= main_litedramcore_bankmachine0_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine0_cmd_payload_a <= ((main_litedramcore_bankmachine0_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine0_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine0_source_valid & main_litedramcore_bankmachine0_source_source_valid)) begin
        if ((main_litedramcore_bankmachine0_source_payload_addr[20:8] != main_litedramcore_bankmachine0_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_bankmachine1_row_hit = (main_litedramcore_bankmachine1_row == main_litedramcore_bankmachine1_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine1_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine1_cmd_payload_a <= main_litedramcore_bankmachine1_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine1_cmd_payload_a <= ((main_litedramcore_bankmachine1_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine1_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine1_source_valid & main_litedramcore_bankmachine1_source_source_valid)) begin
        if ((main_litedramcore_bankmachine1_source_payload_addr[20:8] != main_litedramcore_bankmachine1_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_bankmachine2_row_hit = (main_litedramcore_bankmachine2_row == main_litedramcore_bankmachine2_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine2_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine2_cmd_payload_a <= main_litedramcore_bankmachine2_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine2_cmd_payload_a <= ((main_litedramcore_bankmachine2_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine2_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine2_source_valid & main_litedramcore_bankmachine2_source_source_valid)) begin
        if ((main_litedramcore_bankmachine2_source_payload_addr[20:8] != main_litedramcore_bankmachine2_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_bankmachine3_row_hit = (main_litedramcore_bankmachine3_row == main_litedramcore_bankmachine3_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine3_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine3_cmd_payload_a <= main_litedramcore_bankmachine3_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine3_cmd_payload_a <= ((main_litedramcore_bankmachine3_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine3_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine3_source_valid & main_litedramcore_bankmachine3_source_source_valid)) begin
        if ((main_litedramcore_bankmachine3_source_payload_addr[20:8] != main_litedramcore_bankmachine3_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_bankmachine4_row_hit = (main_litedramcore_bankmachine4_row == main_litedramcore_bankmachine4_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine4_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine4_cmd_payload_a <= main_litedramcore_bankmachine4_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine4_cmd_payload_a <= ((main_litedramcore_bankmachine4_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine4_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine4_source_valid & main_litedramcore_bankmachine4_source_source_valid)) begin
        if ((main_litedramcore_bankmachine4_source_payload_addr[20:8] != main_litedramcore_bankmachine4_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_bankmachine5_row_hit = (main_litedramcore_bankmachine5_row == main_litedramcore_bankmachine5_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine5_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine5_cmd_payload_a <= main_litedramcore_bankmachine5_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine5_cmd_payload_a <= ((main_litedramcore_bankmachine5_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine5_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine5_source_valid & main_litedramcore_bankmachine5_source_source_valid)) begin
        if ((main_litedramcore_bankmachine5_source_payload_addr[20:8] != main_litedramcore_bankmachine5_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_bankmachine6_row_hit = (main_litedramcore_bankmachine6_row == main_litedramcore_bankmachine6_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine6_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine6_cmd_payload_a <= main_litedramcore_bankmachine6_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine6_cmd_payload_a <= ((main_litedramcore_bankmachine6_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine6_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine6_source_valid & main_litedramcore_bankmachine6_source_source_valid)) begin
        if ((main_litedramcore_bankmachine6_source_payload_addr[20:8] != main_litedramcore_bankmachine6_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_bankmachine7_row_hit = (main_litedramcore_bankmachine7_row == main_litedramcore_bankmachine7_source_source_payload_addr[20:8]);
...
always @(*) begin
    ...
    if (main_litedramcore_bankmachine7_row_col_n_addr_sel) begin
        main_litedramcore_bankmachine7_cmd_payload_a <= main_litedramcore_bankmachine7_source_source_payload_addr[20:8];
    end else begin
        main_litedramcore_bankmachine7_cmd_payload_a <= ((main_litedramcore_bankmachine7_auto_precharge <<< 4'd10) | {main_litedramcore_bankmachine7_source_source_payload_addr[7:0], {2{1'd0}}});
    end
end
...
always @(*) begin
    ...
    if ((main_litedramcore_bankmachine7_source_valid & main_litedramcore_bankmachine7_source_source_valid)) begin
        if ((main_litedramcore_bankmachine7_source_payload_addr[20:8] != main_litedramcore_bankmachine7_source_source_payload_addr[20:8])) begin
...
assign main_litedramcore_settings = (main_a7ddrphy_rdphase_storage - 1'd1);
assign main_litedramcore_interface = (main_a7ddrphy_wrphase_storage - 1'd1);
...
always @(*) begin
    ...
    case (builder_multiplexer_state)
        1'd1: begin
            ...
            if ((main_litedramcore_interface == 1'd0)) begin
        ...
        default: begin
            ...
            if ((main_litedramcore_settings == 1'd0)) begin
                main_litedramcore_steerer_sel0 <= 1'd1;
            end
        end
    endcase
...
always @(*) begin
    ...
    case (builder_multiplexer_state)
        1'd1: begin
            ...
            if ((main_litedramcore_interface == 1'd1)) begin
        ...
        default: begin
            ...
            if ((main_litedramcore_settings == 1'd1)) begin
                main_litedramcore_steerer_sel1 <= 1'd1;
            end
        end
    endcase
...
assign main_ce = ((~main_user_port_cmd_valid) | (main_user_port_cmd_ready & main_user_port_cmd_last));
always @(*) begin
    main_request <= 2'd0;
...
assign main_write_w_buffer_queue = ((main_user_port_cmd_valid & main_user_port_cmd_ready) & main_user_port_cmd_payload_we);
...
always @(*) begin
    ...
    if ((main_write_cmd_request & main_write_cmd_grant)) begin
        if (main_user_port_cmd_ready) begin
...
always @(*) begin
    main_user_port_cmd_last <= 1'd0;
    if ((main_write_cmd_request & main_write_cmd_grant)) begin
        main_user_port_cmd_last <= main_write_aw_last;
    end
    if ((main_read_cmd_request & main_read_cmd_grant)) begin
        main_user_port_cmd_last <= main_read_ar_last;
    end
end
always @(*) begin
    main_user_port_cmd_payload_we <= 1'd0;
    if ((main_write_cmd_request & main_write_cmd_grant)) begin
        main_user_port_cmd_payload_we <= 1'd1;
    end
    if ((main_read_cmd_request & main_read_cmd_grant)) begin
        main_user_port_cmd_payload_we <= 1'd0;
    end
...
always @(*) begin
    main_user_port_cmd_payload_addr <= 24'd0;
    if ((main_write_cmd_request & main_write_cmd_grant)) begin
        main_user_port_cmd_payload_addr <= ((main_write_aw_payload_addr - 1'd0) >>> 2'd3);
    end
    if ((main_read_cmd_request & main_read_cmd_grant)) begin
        main_user_port_cmd_payload_addr <= ((main_read_ar_payload_addr - 1'd0) >>> 2'd3);
    end
end
always @(*) begin
...
assign main_user_port_wdata_valid = (main_write_w_buffer_source_valid & (main_write_w_buffer_level2 > 1'd0));
assign main_user_port_wdata_payload_data = main_write_w_buffer_source_payload_data;
assign main_user_port_wdata_payload_we = main_write_w_buffer_source_payload_strb;
assign main_write_w_buffer_source_ready = (main_user_port_wdata_ready & (main_write_w_buffer_level2 > 1'd0));
...
assign main_read_r_buffer_queue = ((main_user_port_cmd_valid & main_user_port_cmd_ready) & (~main_user_port_cmd_payload_we));
...
assign main_read_r_buffer_sink_valid = main_user_port_rdata_valid;
assign main_user_port_rdata_ready = main_read_r_buffer_sink_ready;
assign main_read_r_buffer_sink_first = main_user_port_rdata_first;
assign main_read_r_buffer_sink_last = main_user_port_rdata_last;
assign main_read_r_buffer_sink_payload_data = main_user_port_rdata_payload_data;
...
always @(*) begin
    ...
    case (main_litedramcore_choose_cmd_grant)
        1'd0: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[0];
        end
        1'd1: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[1];
        end
        2'd2: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[2];
        end
        2'd3: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[3];
        end
        3'd4: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[4];
        end
        3'd5: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[5];
        end
        3'd6: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[6];
        end
        default: begin
            builder_rhs_self0 <= main_litedramcore_choose_cmd_requests[7];
        end
    endcase
end
always @(*) begin
    builder_rhs_self1 <= 13'd0;
    case (main_litedramcore_choose_cmd_grant)
        1'd0: begin
...
always @(*) begin
    ...
    case (main_litedramcore_choose_req_grant)
        1'd0: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[0];
        end
        1'd1: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[1];
        end
        2'd2: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[2];
        end
        2'd3: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[3];
        end
        3'd4: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[4];
        end
        3'd5: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[5];
        end
        3'd6: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[6];
        end
        default: begin
            builder_rhs_self6 <= main_litedramcore_choose_req_requests[7];
        end
    endcase
end
always @(*) begin
    builder_rhs_self7 <= 13'd0;
    case (main_litedramcore_choose_req_grant)
        1'd0: begin
...
always @(*) begin
    ...
    case (builder_roundrobin0_grant)
        default: begin
            builder_rhs_self12 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_roundrobin1_grant)
        default: begin
            builder_rhs_self15 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_roundrobin1_grant)
        default: begin
            builder_rhs_self17 <= (((main_user_port_cmd_payload_addr[10:8] == 1'd1) & (~(((((((builder_locked1 | (main_litedramcore_interface_bank0_lock & (builder_roundrobin0_grant == 1'd0))) | (main_litedramcore_interface_bank2_lock & (builder_roundrobin2_grant == 1'd0))) | (main_litedramcore_interface_bank3_lock & (builder_roundrobin3_grant == 1'd0))) | (main_litedramcore_interface_bank4_lock & (builder_roundrobin4_grant == 1'd0))) | (main_litedramcore_interface_bank5_lock & (builder_roundrobin5_grant == 1'd0))) | (main_litedramcore_interface_bank6_lock & (builder_roundrobin6_grant == 1'd0))) | (main_litedramcore_interface_bank7_lock & (builder_roundrobin7_grant == 1'd0))))) & main_user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_roundrobin2_grant)
        default: begin
            builder_rhs_self18 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_roundrobin2_grant)
        default: begin
            builder_rhs_self20 <= (((main_user_port_cmd_payload_addr[10:8] == 2'd2) & (~(((((((builder_locked2 | (main_litedramcore_interface_bank0_lock & (builder_roundrobin0_grant == 1'd0))) | (main_litedramcore_interface_bank1_lock & (builder_roundrobin1_grant == 1'd0))) | (main_litedramcore_interface_bank3_lock & (builder_roundrobin3_grant == 1'd0))) | (main_litedramcore_interface_bank4_lock & (builder_roundrobin4_grant == 1'd0))) | (main_litedramcore_interface_bank5_lock & (builder_roundrobin5_grant == 1'd0))) | (main_litedramcore_interface_bank6_lock & (builder_roundrobin6_grant == 1'd0))) | (main_litedramcore_interface_bank7_lock & (builder_roundrobin7_grant == 1'd0))))) & main_user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_roundrobin3_grant)
        default: begin
            builder_rhs_self21 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_roundrobin3_grant)
        default: begin
            builder_rhs_self23 <= (((main_user_port_cmd_payload_addr[10:8] == 2'd3) & (~(((((((builder_locked3 | (main_litedramcore_interface_bank0_lock & (builder_roundrobin0_grant == 1'd0))) | (main_litedramcore_interface_bank1_lock & (builder_roundrobin1_grant == 1'd0))) | (main_litedramcore_interface_bank2_lock & (builder_roundrobin2_grant == 1'd0))) | (main_litedramcore_interface_bank4_lock & (builder_roundrobin4_grant == 1'd0))) | (main_litedramcore_interface_bank5_lock & (builder_roundrobin5_grant == 1'd0))) | (main_litedramcore_interface_bank6_lock & (builder_roundrobin6_grant == 1'd0))) | (main_litedramcore_interface_bank7_lock & (builder_roundrobin7_grant == 1'd0))))) & main_user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_roundrobin4_grant)
        default: begin
            builder_rhs_self24 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_roundrobin4_grant)
        default: begin
            builder_rhs_self26 <= (((main_user_port_cmd_payload_addr[10:8] == 3'd4) & (~(((((((builder_locked4 | (main_litedramcore_interface_bank0_lock & (builder_roundrobin0_grant == 1'd0))) | (main_litedramcore_interface_bank1_lock & (builder_roundrobin1_grant == 1'd0))) | (main_litedramcore_interface_bank2_lock & (builder_roundrobin2_grant == 1'd0))) | (main_litedramcore_interface_bank3_lock & (builder_roundrobin3_grant == 1'd0))) | (main_litedramcore_interface_bank5_lock & (builder_roundrobin5_grant == 1'd0))) | (main_litedramcore_interface_bank6_lock & (builder_roundrobin6_grant == 1'd0))) | (main_litedramcore_interface_bank7_lock & (builder_roundrobin7_grant == 1'd0))))) & main_user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_roundrobin5_grant)
        default: begin
            builder_rhs_self27 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_roundrobin5_grant)
        default: begin
            builder_rhs_self29 <= (((main_user_port_cmd_payload_addr[10:8] == 3'd5) & (~(((((((builder_locked5 | (main_litedramcore_interface_bank0_lock & (builder_roundrobin0_grant == 1'd0))) | (main_litedramcore_interface_bank1_lock & (builder_roundrobin1_grant == 1'd0))) | (main_litedramcore_interface_bank2_lock & (builder_roundrobin2_grant == 1'd0))) | (main_litedramcore_interface_bank3_lock & (builder_roundrobin3_grant == 1'd0))) | (main_litedramcore_interface_bank4_lock & (builder_roundrobin4_grant == 1'd0))) | (main_litedramcore_interface_bank6_lock & (builder_roundrobin6_grant == 1'd0))) | (main_litedramcore_interface_bank7_lock & (builder_roundrobin7_grant == 1'd0))))) & main_user_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_roundrobin6_grant)
        default: begin
            builder_rhs_self30 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_roundrobin7_grant)
        default: begin
            builder_rhs_self33 <= {main_user_port_cmd_payload_addr[23:11], main_user_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(posedge sys_clk) begin
    ...
    if ((main_litedramcore_timer_wait & (~main_litedramcore_timer_done0))) begin
        ...
        main_litedramcore_timer_count1 <= 9'd468;
    end
    ...
    if ((main_litedramcore_sequencer_trigger == 2'd2)) begin
        main_litedramcore_cmd_payload_a <= 11'd1024;
        main_litedramcore_cmd_payload_ba <= 1'd0;
    ...
    if ((main_litedramcore_sequencer_trigger == 4'd11)) begin
        main_litedramcore_cmd_payload_a <= 1'd0;
        main_litedramcore_cmd_payload_ba <= 1'd0;
        main_litedramcore_cmd_payload_cas <= 1'd0;
        main_litedramcore_cmd_payload_ras <= 1'd0;
    ...
    if (main_litedramcore_bankmachine0_row_close) begin
        ...
        if (main_litedramcore_bankmachine0_row_open) begin
            ...
            main_litedramcore_bankmachine0_row <= main_litedramcore_bankmachine0_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_bankmachine1_row_close) begin
        ...
        if (main_litedramcore_bankmachine1_row_open) begin
            ...
            main_litedramcore_bankmachine1_row <= main_litedramcore_bankmachine1_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_bankmachine2_row_close) begin
        ...
        if (main_litedramcore_bankmachine2_row_open) begin
            ...
            main_litedramcore_bankmachine2_row <= main_litedramcore_bankmachine2_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_bankmachine3_row_close) begin
        ...
        if (main_litedramcore_bankmachine3_row_open) begin
            ...
            main_litedramcore_bankmachine3_row <= main_litedramcore_bankmachine3_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_bankmachine4_row_close) begin
        ...
        if (main_litedramcore_bankmachine4_row_open) begin
            ...
            main_litedramcore_bankmachine4_row <= main_litedramcore_bankmachine4_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_bankmachine5_row_close) begin
        ...
        if (main_litedramcore_bankmachine5_row_open) begin
            ...
            main_litedramcore_bankmachine5_row <= main_litedramcore_bankmachine5_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_bankmachine6_row_close) begin
        ...
        if (main_litedramcore_bankmachine6_row_open) begin
            ...
            main_litedramcore_bankmachine6_row <= main_litedramcore_bankmachine6_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_bankmachine7_row_close) begin
        ...
        if (main_litedramcore_bankmachine7_row_open) begin
            ...
            main_litedramcore_bankmachine7_row <= main_litedramcore_bankmachine7_source_source_payload_addr[20:8];
        end
    end
    ...
    if (main_litedramcore_twtrcon_valid) begin
        main_litedramcore_twtrcon_count <= 2'd2;
        if (1'd0) begin
    ...
    if (main_write_w_buffer_queue) begin
        ...
        if ((main_write_w_buffer_dequeue & (main_write_w_buffer_level2 > 1'd0))) begin
            main_write_w_buffer_level2 <= (main_write_w_buffer_level2 - 1'd1);
        end
    end
    ...
    if (sys_rst) begin
        ...
        main_litedramcore_postponer_count <= 1'd0;
        main_litedramcore_sequencer_done1 <= 1'd0;
        main_litedramcore_sequencer_trigger <= 4'd0;
        main_litedramcore_sequencer_count <= 1'd0;
        ...
        main_write_pipe_valid_source_payload_addr <= 27'd0;
        ...
        main_read_pipe_valid_source_payload_addr <= 27'd0;
...
//------------------------------------------------------------------------------
// Memory storage_8: 16-words x 81-bit
//------------------------------------------------------------------------------
// Port 0 | Read: ----  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Sync  | Write: ---- | 
reg [80:0] storage_8[0:15];
reg [80:0] storage_8_dat1;
always @(posedge sys_clk) begin
...
always @(posedge sys_clk) begin
	if (main_write_w_buffer_rdport_re)
		storage_8_dat1 <= storage_8[main_write_w_buffer_rdport_adr];
end
assign main_write_w_buffer_rdport_dat_r = storage_8_dat1;


//------------------------------------------------------------------------------
// Memory storage_9: 16-words x 7-bit
//------------------------------------------------------------------------------
// Port 0 | Read: ----  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Async | Write: ---- | 
reg [6:0] storage_9[0:15];
always @(posedge sys_clk) begin
...
//------------------------------------------------------------------------------
// Memory storage_10: 16-words x 9-bit
//------------------------------------------------------------------------------
// Port 0 | Read: ----  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Async | Write: ---- | 
reg [8:0] storage_10[0:15];
always @(posedge sys_clk) begin
...
//------------------------------------------------------------------------------
// Memory storage_11: 16-words x 75-bit
//------------------------------------------------------------------------------
// Port 0 | Read: ----  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Sync  | Write: ---- | 
reg [74:0] storage_11[0:15];
reg [74:0] storage_11_dat1;
always @(posedge sys_clk) begin
...
always @(posedge sys_clk) begin
	if (main_read_r_buffer_rdport_re)
		storage_11_dat1 <= storage_11[main_read_r_buffer_rdport_adr];
end
assign main_read_r_buffer_rdport_dat_r = storage_11_dat1;


//------------------------------------------------------------------------------
// Memory storage_12: 16-words x 7-bit
//------------------------------------------------------------------------------
// Port 0 | Read: ----  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Async | Write: ---- | 
reg [6:0] storage_12[0:15];
always @(posedge sys_clk) begin
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-07-22 00:49:50.
//------------------------------------------------------------------------------
