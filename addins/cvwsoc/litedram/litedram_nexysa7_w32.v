...
//
// Filename   : litedram_nexysa7_w32.v
// Top        : LiteDRAMCore
// Device     : 
// Hierarchy  : disabled
// LiteX sha1 : 777d97377
// Date       : 2026-07-22 00:49:43
//------------------------------------------------------------------------------
...
│         │         ├── syncfifo_2 (SyncFIFO) [Gen]
│         │         │    └── buffer_0 (Buffer) [Gen]
│         │         │         ├── pipe_valid (PipeValid)
│         │         │         └── pipeline (Pipeline)
│         │         └── syncfifo_3 (SyncFIFO) [Gen]
│         │              └── buffer_0 (Buffer) [Gen]
│         │                   ├── pipe_valid (PipeValid)
│         │                   └── pipeline (Pipeline)
│         ├── roundrobin_0 (RoundRobin) [Gen]
...
reg     [7:0] main_choose_cmd_requests = 8'd0;
...
reg     [7:0] main_choose_req_requests = 8'd0;
...
reg     [1:0] main_litedramnativeportconverter_port_to = 2'd0;
reg     [1:0] main_litedramnativeportconverter_port_to_litedramcore_next_value3 = 2'd0;
...
wire          main_litedramnativeportconverter_rdata_fifo_level;
...
wire          main_litedramnativeportconverter_self_level;
reg           main_litedramnativeportconverter_self_sink_first = 1'd0;
reg           main_litedramnativeportconverter_self_sink_last = 1'd0;
reg     [1:0] main_litedramnativeportconverter_self_sink_payload_sel = 2'd0;
reg           main_litedramnativeportconverter_self_sink_payload_we = 1'd0;
wire          main_litedramnativeportconverter_self_sink_ready;
reg           main_litedramnativeportconverter_self_sink_valid = 1'd0;
wire          main_litedramnativeportconverter_self_source_first;
wire          main_litedramnativeportconverter_self_source_last;
wire    [1:0] main_litedramnativeportconverter_self_source_payload_sel;
wire          main_litedramnativeportconverter_self_source_payload_we;
wire          main_litedramnativeportconverter_self_source_ready;
wire          main_litedramnativeportconverter_self_source_valid;
wire          main_litedramnativeportconverter_wdata_buffer_level;
...
wire          main_litedramnativeportconverter_wdata_fifo_level;
...
reg    [24:0] main_new_port_cmd_payload_addr = 25'd0;
...
wire   [42:0] main_read_r_buffer_rdport_dat_r;
...
wire   [42:0] main_read_r_buffer_syncfifo_din;
wire   [42:0] main_read_r_buffer_syncfifo_dout;
...
wire   [42:0] main_read_r_buffer_wrport_dat_w;
...
reg     [3:0] main_sequencer_trigger = 4'd0;
wire          main_settings;
...
reg     [8:0] main_timer_count1 = 9'd468;
...
wire   [44:0] main_write_w_buffer_rdport_dat_r;
...
wire   [44:0] main_write_w_buffer_syncfifo_din;
wire   [44:0] main_write_w_buffer_syncfifo_dout;
...
wire   [44:0] main_write_w_buffer_wrport_dat_w;
...
assign main_settings = (main_a7ddrphy_rdphase_storage - 1'd1);
assign main_interface = (main_a7ddrphy_wrphase_storage - 1'd1);
...
assign main_litedramnativeportconverter_self_source_ready = (main_litedramnativeportconverter_wdata_finished | main_litedramnativeportconverter_rdata_finished);
...
assign main_litedramnativeportconverter_next_cmd = ((((main_litedramnativeportconverter_addr_changed | (main_litedramnativeportconverter_cmd_we != main_new_port_cmd_payload_we)) | (main_litedramnativeportconverter_port_to == 2'd3)) | main_litedramnativeportconverter_cmd_last) | main_new_port_flush);
...
assign main_litedramnativeportconverter_rdata_chunk_valid = ((main_litedramnativeportconverter_self_source_payload_sel & main_litedramnativeportconverter_rdata_chunk) != 1'd0);
always @(*) begin
    main_new_port_rdata_payload_data <= 32'd0;
    if ((main_litedramnativeportconverter_self_source_valid & (~main_litedramnativeportconverter_self_source_payload_we))) begin
...
assign main_litedramnativeportconverter_wdata_chunk_valid = ((main_litedramnativeportconverter_self_source_payload_sel & main_litedramnativeportconverter_wdata_chunk) != 1'd0);
always @(*) begin
...
assign main_litedramnativeportconverter_self_source_valid = main_litedramnativeportconverter_self_sink_valid;
assign main_litedramnativeportconverter_self_sink_ready = main_litedramnativeportconverter_self_source_ready;
assign main_litedramnativeportconverter_self_source_first = main_litedramnativeportconverter_self_sink_first;
assign main_litedramnativeportconverter_self_source_last = main_litedramnativeportconverter_self_sink_last;
assign main_litedramnativeportconverter_self_source_payload_sel = main_litedramnativeportconverter_self_sink_payload_sel;
assign main_litedramnativeportconverter_self_source_payload_we = main_litedramnativeportconverter_self_sink_payload_we;
assign main_litedramnativeportconverter_self_level = 1'd0;
always @(*) begin
    ...
    case (builder_litedramcore_state)
        ...
        2'd3: begin
            if (main_litedramnativeportconverter_self_sink_ready) begin
                if (main_litedramnativeportconverter_cmd_we) begin
...
always @(*) begin
    main_litedramnativeportconverter_self_sink_payload_we <= 1'd0;
    case (builder_litedramcore_state)
        1'd1: begin
        end
        2'd2: begin
        ...
        2'd3: begin
            main_litedramnativeportconverter_self_sink_payload_we <= main_litedramnativeportconverter_cmd_we;
        end
        default: begin
        end
    endcase
...
always @(*) begin
    main_litedramnativeportconverter_port_to_litedramcore_next_value3 <= 2'd0;
    case (builder_litedramcore_state)
        1'd1: begin
        end
        2'd2: begin
            if (main_litedramnativeportconverter_next_cmd) begin
                ...
                if (main_new_port_cmd_valid) begin
                    main_litedramnativeportconverter_port_to_litedramcore_next_value3 <= (main_litedramnativeportconverter_port_to | (1'd1 <<< main_new_port_cmd_payload_addr[0]));
                end
            end
        end
        2'd3: begin
        ...
        default: begin
            if (main_new_port_cmd_ready) begin
                main_litedramnativeportconverter_port_to_litedramcore_next_value3 <= (1'd1 <<< main_new_port_cmd_payload_addr[0]);
            end
        end
    endcase
end
always @(*) begin
    main_litedramnativeportconverter_port_to_litedramcore_next_value_ce3 <= 1'd0;
    case (builder_litedramcore_state)
        1'd1: begin
        end
        2'd2: begin
            if (main_litedramnativeportconverter_next_cmd) begin
                ...
                if (main_new_port_cmd_valid) begin
                    main_litedramnativeportconverter_port_to_litedramcore_next_value_ce3 <= 1'd1;
                end
            end
        end
        2'd3: begin
...
always @(*) begin
    main_litedramnativeportconverter_self_sink_valid <= 1'd0;
    case (builder_litedramcore_state)
        1'd1: begin
        end
        2'd2: begin
        ...
        2'd3: begin
            main_litedramnativeportconverter_self_sink_valid <= 1'd1;
        end
        default: begin
        end
    endcase
...
always @(*) begin
    main_litedramnativeportconverter_self_sink_payload_sel <= 2'd0;
    case (builder_litedramcore_state)
        1'd1: begin
        end
        2'd2: begin
        ...
        2'd3: begin
            main_litedramnativeportconverter_self_sink_payload_sel <= main_litedramnativeportconverter_port_to;
        end
        default: begin
        end
    endcase
...
assign main_litedramnativeportconverter_rdata_fifo_level = main_litedramnativeportconverter_rdata_fifo_source_source_valid;
...
assign main_litedramnativeportconverter_wdata_fifo_level = main_litedramnativeportconverter_wdata_fifo_source_source_valid;
...
assign main_litedramnativeportconverter_wdata_buffer_level = main_litedramnativeportconverter_wdata_buffer_source_source_valid;
...
always @(*) begin
    main_new_port_cmd_payload_addr <= 25'd0;
    if ((main_write_cmd_request & main_write_cmd_grant)) begin
...
assign main_new_port_wdata_valid = (main_write_w_buffer_source_valid & (main_write_w_buffer_level2 > 1'd0));
...
assign main_write_w_buffer_source_ready = (main_new_port_wdata_ready & (main_write_w_buffer_level2 > 1'd0));
...
always @(*) begin
    ...
    if ((builder_csrbank2_sel & (builder_interface2_bank_bus_adr[8:0] == 2'd2))) begin
        main_phaseinjector0_command_issue_we <= builder_interface2_bank_bus_re;
    end
end
always @(*) begin
...
always @(*) begin
    ...
    if ((builder_csrbank2_sel & (builder_interface2_bank_bus_adr[8:0] == 4'd8))) begin
        main_phaseinjector1_command_issue_we <= builder_interface2_bank_bus_re;
    end
end
...
assign builder_csrbank2_dfii_control0_w = main_storage;
...
assign builder_csrbank2_dfii_pi0_command0_w = main_phaseinjector0_command_storage;
assign builder_csrbank2_dfii_pi0_address0_w = main_phaseinjector0_address_storage;
assign builder_csrbank2_dfii_pi0_baddress0_w = main_phaseinjector0_baddress_storage;
assign builder_csrbank2_dfii_pi0_wrdata0_w = main_phaseinjector0_wrdata_storage;
assign builder_csrbank2_dfii_pi0_rddata_w = main_phaseinjector0_rddata_status;
...
assign builder_csrbank2_dfii_pi1_command0_w = main_phaseinjector1_command_storage;
assign builder_csrbank2_dfii_pi1_address0_w = main_phaseinjector1_address_storage;
assign builder_csrbank2_dfii_pi1_baddress0_w = main_phaseinjector1_baddress_storage;
assign builder_csrbank2_dfii_pi1_wrdata0_w = main_phaseinjector1_wrdata_storage;
assign builder_csrbank2_dfii_pi1_rddata_w = main_phaseinjector1_rddata_status;
...
always @(*) begin
    ...
    case (main_choose_cmd_grant)
        1'd0: begin
            builder_rhs_self0 <= main_choose_cmd_requests[0];
        end
        1'd1: begin
            builder_rhs_self0 <= main_choose_cmd_requests[1];
        end
        2'd2: begin
            builder_rhs_self0 <= main_choose_cmd_requests[2];
        end
        2'd3: begin
            builder_rhs_self0 <= main_choose_cmd_requests[3];
        end
        3'd4: begin
            builder_rhs_self0 <= main_choose_cmd_requests[4];
        end
        3'd5: begin
            builder_rhs_self0 <= main_choose_cmd_requests[5];
        end
        3'd6: begin
            builder_rhs_self0 <= main_choose_cmd_requests[6];
        end
        default: begin
            builder_rhs_self0 <= main_choose_cmd_requests[7];
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (main_choose_req_grant)
        1'd0: begin
            builder_rhs_self6 <= main_choose_req_requests[0];
        end
        1'd1: begin
            builder_rhs_self6 <= main_choose_req_requests[1];
        end
        2'd2: begin
            builder_rhs_self6 <= main_choose_req_requests[2];
        end
        2'd3: begin
            builder_rhs_self6 <= main_choose_req_requests[3];
        end
        3'd4: begin
            builder_rhs_self6 <= main_choose_req_requests[4];
        end
        3'd5: begin
            builder_rhs_self6 <= main_choose_req_requests[5];
        end
        3'd6: begin
            builder_rhs_self6 <= main_choose_req_requests[6];
        end
        default: begin
            builder_rhs_self6 <= main_choose_req_requests[7];
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin0_grant)
        default: begin
            builder_rhs_self12 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin1_grant)
        default: begin
            builder_rhs_self15 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin2_grant)
        default: begin
            builder_rhs_self18 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin2_grant)
        default: begin
            builder_rhs_self20 <= (((main_port_cmd_payload_addr[10:8] == 2'd2) & (~(((((((builder_litedramcore_locked2 | (main_interface_bank0_lock & (builder_litedramcore_roundrobin0_grant == 1'd0))) | (main_interface_bank1_lock & (builder_litedramcore_roundrobin1_grant == 1'd0))) | (main_interface_bank3_lock & (builder_litedramcore_roundrobin3_grant == 1'd0))) | (main_interface_bank4_lock & (builder_litedramcore_roundrobin4_grant == 1'd0))) | (main_interface_bank5_lock & (builder_litedramcore_roundrobin5_grant == 1'd0))) | (main_interface_bank6_lock & (builder_litedramcore_roundrobin6_grant == 1'd0))) | (main_interface_bank7_lock & (builder_litedramcore_roundrobin7_grant == 1'd0))))) & main_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin3_grant)
        default: begin
            builder_rhs_self21 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin3_grant)
        default: begin
            builder_rhs_self23 <= (((main_port_cmd_payload_addr[10:8] == 2'd3) & (~(((((((builder_litedramcore_locked3 | (main_interface_bank0_lock & (builder_litedramcore_roundrobin0_grant == 1'd0))) | (main_interface_bank1_lock & (builder_litedramcore_roundrobin1_grant == 1'd0))) | (main_interface_bank2_lock & (builder_litedramcore_roundrobin2_grant == 1'd0))) | (main_interface_bank4_lock & (builder_litedramcore_roundrobin4_grant == 1'd0))) | (main_interface_bank5_lock & (builder_litedramcore_roundrobin5_grant == 1'd0))) | (main_interface_bank6_lock & (builder_litedramcore_roundrobin6_grant == 1'd0))) | (main_interface_bank7_lock & (builder_litedramcore_roundrobin7_grant == 1'd0))))) & main_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin4_grant)
        default: begin
            builder_rhs_self24 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin5_grant)
        default: begin
            builder_rhs_self27 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin5_grant)
        default: begin
            builder_rhs_self29 <= (((main_port_cmd_payload_addr[10:8] == 3'd5) & (~(((((((builder_litedramcore_locked5 | (main_interface_bank0_lock & (builder_litedramcore_roundrobin0_grant == 1'd0))) | (main_interface_bank1_lock & (builder_litedramcore_roundrobin1_grant == 1'd0))) | (main_interface_bank2_lock & (builder_litedramcore_roundrobin2_grant == 1'd0))) | (main_interface_bank3_lock & (builder_litedramcore_roundrobin3_grant == 1'd0))) | (main_interface_bank4_lock & (builder_litedramcore_roundrobin4_grant == 1'd0))) | (main_interface_bank6_lock & (builder_litedramcore_roundrobin6_grant == 1'd0))) | (main_interface_bank7_lock & (builder_litedramcore_roundrobin7_grant == 1'd0))))) & main_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin6_grant)
        default: begin
            builder_rhs_self30 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin6_grant)
        default: begin
            builder_rhs_self32 <= (((main_port_cmd_payload_addr[10:8] == 3'd6) & (~(((((((builder_litedramcore_locked6 | (main_interface_bank0_lock & (builder_litedramcore_roundrobin0_grant == 1'd0))) | (main_interface_bank1_lock & (builder_litedramcore_roundrobin1_grant == 1'd0))) | (main_interface_bank2_lock & (builder_litedramcore_roundrobin2_grant == 1'd0))) | (main_interface_bank3_lock & (builder_litedramcore_roundrobin3_grant == 1'd0))) | (main_interface_bank4_lock & (builder_litedramcore_roundrobin4_grant == 1'd0))) | (main_interface_bank5_lock & (builder_litedramcore_roundrobin5_grant == 1'd0))) | (main_interface_bank7_lock & (builder_litedramcore_roundrobin7_grant == 1'd0))))) & main_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin7_grant)
        default: begin
            builder_rhs_self33 <= {main_port_cmd_payload_addr[23:11], main_port_cmd_payload_addr[7:0]};
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (builder_litedramcore_roundrobin7_grant)
        default: begin
            builder_rhs_self35 <= (((main_port_cmd_payload_addr[10:8] == 3'd7) & (~(((((((builder_litedramcore_locked7 | (main_interface_bank0_lock & (builder_litedramcore_roundrobin0_grant == 1'd0))) | (main_interface_bank1_lock & (builder_litedramcore_roundrobin1_grant == 1'd0))) | (main_interface_bank2_lock & (builder_litedramcore_roundrobin2_grant == 1'd0))) | (main_interface_bank3_lock & (builder_litedramcore_roundrobin3_grant == 1'd0))) | (main_interface_bank4_lock & (builder_litedramcore_roundrobin4_grant == 1'd0))) | (main_interface_bank5_lock & (builder_litedramcore_roundrobin5_grant == 1'd0))) | (main_interface_bank6_lock & (builder_litedramcore_roundrobin6_grant == 1'd0))))) & main_port_cmd_valid);
        end
    endcase
end
always @(*) begin
    ...
    case (main_steerer_sel0)
        1'd0: begin
            builder_self0 <= main_nop_ba;
        end
        1'd1: begin
            builder_self0 <= main_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            builder_self0 <= main_choose_req_cmd_payload_ba;
        end
        default: begin
            builder_self0 <= main_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(*) begin
    ...
    case (main_steerer_sel1)
        1'd0: begin
            builder_self7 <= main_nop_ba;
        end
        1'd1: begin
            builder_self7 <= main_choose_cmd_cmd_payload_ba;
        end
        2'd2: begin
            builder_self7 <= main_choose_req_cmd_payload_ba;
        end
        default: begin
            builder_self7 <= main_cmd_payload_ba;
        end
    endcase
end
always @(*) begin
...
always @(posedge sys_clk) begin
    ...
    if ((main_sequencer_trigger == 4'd11)) begin
        main_cmd_payload_a <= 1'd0;
        main_cmd_payload_ba <= 1'd0;
        main_cmd_payload_cas <= 1'd0;
        main_cmd_payload_ras <= 1'd0;
    ...
    if (((main_litedramnativeportconverter_self_source_valid & main_litedramnativeportconverter_self_source_payload_we) & main_litedramnativeportconverter_wdata_chunk[1])) begin
        main_litedramnativeportconverter_wdata_sel <= {{4{main_litedramnativeportconverter_self_source_payload_sel[1]}}, {4{main_litedramnativeportconverter_self_source_payload_sel[0]}}};
    end
    ...
    if (main_litedramnativeportconverter_port_to_litedramcore_next_value_ce3) begin
        main_litedramnativeportconverter_port_to <= main_litedramnativeportconverter_port_to_litedramcore_next_value3;
    end
    ...
    if (sys_rst) begin
        ...
        main_litedramnativeportconverter_port_to <= 2'd0;
...
//------------------------------------------------------------------------------
// Memory storage_8: 16-words x 45-bit
//------------------------------------------------------------------------------
// Port 0 | Read: ----  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Sync  | Write: ---- | 
reg [44:0] storage_8[0:15];
reg [44:0] storage_8_dat1;
always @(posedge sys_clk) begin
...
//------------------------------------------------------------------------------
// Memory storage_11: 16-words x 43-bit
//------------------------------------------------------------------------------
// Port 0 | Read: ----  | Write: Sync | Mode: Read-First 
// Port 1 | Read: Sync  | Write: ---- | 
reg [42:0] storage_11[0:15];
reg [42:0] storage_11_dat1;
always @(posedge sys_clk) begin
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-07-22 00:49:44.
//------------------------------------------------------------------------------
